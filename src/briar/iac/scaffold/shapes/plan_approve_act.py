...
_PLAN_PROMPT = (
    ...
    "\n"
    "## Files to change\n"
    "Bulleted list. Each line: `<path> — <one-line why>`. Cross-check "
    "each path against the `active-work` section; if a path appears in "
    "an open PR, REMOVE it and adjust the plan.\n"
    "\n"
    "## Diff sketch\n"
    ...
    "\n"
    "## Risks\n"
    "Anything a reviewer should look at twice. Empty section ('none "
    "identified') is allowed — but only after you've genuinely checked.\n"
    "\n"
